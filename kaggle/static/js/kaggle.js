    ...
    initMediaGeneration() {
        ...
        if (downloadMediaBtn) {
            downloadMediaBtn.addEventListener('click', () => {
                ...
                this.generateFromEnhancedPrompt(mediaType);
            });
        }
        ...
        if (directGenerationBtn) {
            directGenerationBtn.addEventListener('click', async () => {
                ...
                try {
                    directGenerationBtn.innerHTML = 'Generating... <i class="fas fa-spinner fa-spin"></i>';
                    directGenerationBtn.disabled = true;
                    ...
                    directGenerationBtn.innerHTML = 'Continue to Generation <i class="fas fa-bolt"></i>';
                    directGenerationBtn.disabled = false;
                }
            });
        }
        ...
        if (continueGenerationBtn) {
            continueGenerationBtn.addEventListener('click', () => {
                const mediaType = document.getElementById('media-type')?.value;
                this.generateFromEnhancedPrompt(mediaType);
            });
        }
